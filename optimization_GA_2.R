...
# changed this
# df_gen <- data.frame("cons_1" = generation, 
#                      "cons_2" = generation, 
#                      "cons_3" = generation, 
#                      "cons_4" = generation)

df_gen <- data.frame("1" = generation)
...
# number of participants of the energetic community
n_community = 2
# to do the calculation of daily repartition => n_periods = 1 
n_periods = 1
periods <- calculate_params_period(n_periods)
df_optimal_combination <- optimize_repartition_GA(n_periods, periods, n_community, df_gen, df_cons)
...
plot_assignation(df_gen, df_gen_assigned)




# should compare with analytical solution:
static_coefficients_daily
