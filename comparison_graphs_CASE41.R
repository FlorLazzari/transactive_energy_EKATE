...
ggsave(filename = paste0("graphs/comparison_payback_CASE41"), plot = p, device = "pdf", width = 8, height = 3)
...
ggsave(filename = paste0("graphs/comparison_investment_CASE41"), plot = p, device = "pdf", width = 8, height = 3)
